...
class ASPP(nn.Module):
    ...
    def forward(self, feature_map):
        ...
        # print(out_1x1.size(), out_3x3_1.size(), out_3x3_2.size(), out_3x3_3.size(), out_img.size())
        out = torch.cat([out_1x1, out_3x3_1, out_3x3_2, out_3x3_3, out_img], 1)
        out = F.relu(self.bn_conv_1x1_3(self.conv_1x1_3(out))) # (shape: (batch_size, 1280, h/16, w/16))
